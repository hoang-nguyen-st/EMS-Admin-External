...
import { DeviceWithTimeSeries } from '@app/interface/device.interface';
...
const CreateLocationPage = () => {
  ...
  const columns: ColumnsType<DeviceWithTimeSeries> = [
    {
        ...
        <Form form={form} layout='vertical'>
          ...
          <div className='grid grid-cols-2 gap-4 mt-4'>
            ...
            <Form.Item
              ...
              name='meterType'
              rules={[{ required: true, message: t<string>('LOCATION.METER_TYPE_REQUIRED') }]}
            >
              <MeterTypeSelect
